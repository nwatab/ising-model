...
export function generateStaticParams() {
  ...
  const beta_hs = [-0.2, -0.1, 0, 0.1, 0.2] as const;
  const params = beta_js.flatMap((beta_j) =>
...
export default async function Home({
  ...
  const betaH = (parseFloat(beta_h) || 0) + 1e-9; // add a small number to fall down on paramagnetic
